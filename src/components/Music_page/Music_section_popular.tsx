...
import { FetchTrack, Track } from "../../ts_files/Music";
import PopularTrack from "./Music_popular_track";
  ...
  render() {
    return (
      <section className="section">
        <h2 className="title_center_hot">Popular tracks</h2>
        <div className="section_popular_music" >
          {
